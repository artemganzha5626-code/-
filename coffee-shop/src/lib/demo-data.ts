...
export const demoContent: SiteContent = {
  ...
  settings: {
    ...
    tagline: 'кав’ярня',
    description:
      'КАВОВА — кав’ярня на лівому березі Дніпра, на проспекті Слобожанський, 67К. Щодня, без вихідних, з 8:00 до 21:00 варимо каву, печемо свіжу випічку та створюємо затишок.',
