# ☕ КАВОВА — сайт кав’ярні

Атмосферний, швидкий і зручний у редагуванні сайт кав’ярні **КАВОВА**.
...
- **Головний екран** — вітальний слайд з анімованим заголовком, spotlight-фон із
  розсипаними кавовими зернами, що реагують на курсор, кнопки «Дивитись меню» та
  «Прокласти маршрут».
- **Про кав’ярню** — історія, філософія, 3 переваги з іконками.
- **Меню КАВОВА** — реальні розділи, позиції, ціни й описи (8 розділів, ~130 позицій).
  Фільтри за розділами, підкатегорії-мітки, лайки та відгуки під кожною позицією.
  Поки без фото — показуємо брендові плитки за типом (кава/матча/вино/коктейль/десерт);
  реальні фото додаються у **/admin** (Supabase Storage).
- **Акаунти** — реєстрація/вхід відвідувачів (Supabase Auth) з перевагами реєстрації.
...
- [x] Тепла преміальна палітра (кремовий/бежевий/кавовий/графіт + тепло-бурштиновий акцент)
